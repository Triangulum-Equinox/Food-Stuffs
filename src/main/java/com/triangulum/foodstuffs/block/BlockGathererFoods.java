...
public class BlockGathererFoods extends Block {

    public static List<ItemStack> drops;

    public BlockGathererFoods(String unlocalizedName, ResourceLocation registryName, List<ItemStack> drops) {
    ...
    @Override
    public Item getItemDropped(IBlockState ibs, Random random, int i) { //for getting the block as an item? Function is nullable, that should make it so the block doesn't drop itself.
        return null;
    }
